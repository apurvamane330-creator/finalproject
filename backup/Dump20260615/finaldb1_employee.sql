...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `FK5v50ed2bjh60n1gc7ifuxmgf4` FOREIGN KEY (`company_id`) REFERENCES `company` (`reg_no`),
  CONSTRAINT `FKfemnv0llvsjg4adl4xl1m0cxv` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`id`),
  CONSTRAINT `FKfow2bhgypdy2ij4oyukrn6cqw` FOREIGN KEY (`dept_id`) REFERENCES `dept` (`did`),
  CONSTRAINT `FKga73hdtpb67twlr9c1i337tyt` FOREIGN KEY (`address_id`) REFERENCES `address` (`flatno`)
