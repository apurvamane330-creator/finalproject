...
CREATE TABLE `invoice_product` (
  ...
  CONSTRAINT `FK806bu27uepq9jw1gksvegoqkd` FOREIGN KEY (`product_id`) REFERENCES `product` (`pid`),
  CONSTRAINT `FKhrqne4uostar9vds76ynsosov` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`iid`)
